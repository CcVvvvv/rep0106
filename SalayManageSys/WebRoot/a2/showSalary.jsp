...
<div class="table_top" style="height:100%">
	<div>
		 <table width="100%" class="top" cellpadding="0" cellspacing="0">
			<tr>
				<td class="td_top"><b>当前位置:</b>&nbsp;人事部>>工资信息</td>
				<td align="right">
				</td>
			</tr>
		 </table>
	...
	<div height="100%" style="margin-top:10px;">
		<div style="margin-bottom:10px;">
				<s:form action="salaryListInf.action" method="post" theme="simple">
				<td>请选择的部门：</td>
					  <s:select label="部门" name="dept" list="{'机械','电子','自动化','计算机','财务处','审计处','保卫处','教务处'}"
					       multiple="false"/> 
