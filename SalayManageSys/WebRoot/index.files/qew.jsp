	...
	<div height="100%" style="margin-top:10px;">
		...
		<fieldset style="width:98%">
           ...
           <tr>
                ...
                <td>医疗险：</td>
                <td ><input type="text" size="1"  value="${attendenceSet.yiliaoxian }"
                name="attendenceSet.yiliaoxian"/>元</td>
            ...
            <tr>
                ...
                <td>取暖补：</td>
                <td ><input type="text" size="1"  value="${attendenceSet.qunuanbu }"
                name="attendenceSet.qunuanbu"/>元</td>
            ...
            <tr>
                ...
                <td>公积金：</td>
                <td ><input type="text" size="1"  value="${attendenceSet.gongjijin }"
                name="attendenceSet.gongjijin"/>元</td>
                  
            </tr>
            <tr>
                <td>旷工罚款：</td>
                <td ><input type="text" size="1"  value="${attendenceSet.cnegletwork }"
                name="attendenceSet.cnegletwork"/>元/时</td>
