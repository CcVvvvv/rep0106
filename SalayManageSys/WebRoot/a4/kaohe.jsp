...
<div class="table_top" style="height:100%">
	<div>
		 <table width="100%" class="top" cellpadding="0" cellspacing="0">
			<tr>
				<td class="td_top"><b>当前位置:</b>&nbsp;学校各部门管理>>考核信息</td>
				<td align="right">
				<!--  
	...
	<div height="100%" style="margin-top:10px;">
		...
		<s:form action="attendenceList.action" method="post" theme="simple">
...
<table border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6">
		  ...
		  <c:forEach items="${attendences}" var="attendence" varStatus="i">
			<tr bgcolor="#FFFFFF">
				...
				<td>
					<a href="attendence!load.action?attendence.aid=${attendence.aid}" >
