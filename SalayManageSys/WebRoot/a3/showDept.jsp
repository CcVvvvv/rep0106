...
<div class="table_top" style="height:100%">
	<div>
		 <table width="100%" class="top" cellpadding="0" cellspacing="0">
			<tr>
				<td class="td_top"><b>当前位置:</b>&nbsp;财务管理>>打印报表</td>
				<td align="right">
				</td>
			</tr>
		 </table>
	...
	<div height="100%" style="margin-top:10px;">
		<div style="margin-bottom:10px;">
				<s:form action="salaryList1.action" method="post" theme="simple">
				<td>请选择汇总部门名称：</td>
					 <s:select name="dept" list="{'机械','电子','自动化','人事处','财务处','审计处','保卫处','教务处'}"
					       multiple="false"/>
			<s:submit cssClass="buttonBack" value="汇总"/>
